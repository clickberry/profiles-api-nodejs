...
function Bus(options) {
  ...
  options.nsqlookupdAddress = options.nsqlookupdAddress || process.env.NSQLOOKUPD_ADDRESS;
  options.nsqlookupdPort = options.nsqlookupdPort || process.env.NSQLOOKUPD_PORT || '4161';
  ...
  var registrations_reader = new nsq.Reader('registrations', 'create-profile', {
    lookupdHTTPAddresses: options.nsqlookupdAddress + ':' + options.nsqlookupdPort
  });
